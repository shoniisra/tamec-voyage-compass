...
const translations: Translations = {
  en: {
    ...
    blog: {
      ...
      latestStoriesSubtitle: 'Discover travel tips, destination guides, and personal stories from our global adventures',
  ...
  es: {
    ...
    blog: {
      ...
      latestStoriesSubtitle: 'Descubre consejos de viaje, guías de destinos e historias personales de nuestras aventuras globales',
